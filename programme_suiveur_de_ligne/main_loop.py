...
GPIO.add_event_detect(gpio_capteur_centre, GPIO.RISING, callback=robot.actualiser_etat_capteurs(), bouncetime =20)
GPIO.add_event_detect(gpio_capteur_droit, GPIO.RISING, callback=robot.actualiser_etat_capteurs(), bouncetime =20)
GPIO.add_event_detect(gpio_capteur_gauche, GPIO.RISING, callback=robot.actualiser_etat_capteurs(), bouncetime =20)
